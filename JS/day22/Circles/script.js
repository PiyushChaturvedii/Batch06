...
function draw() {
  ...
  origin.x =
    window.innerWidth * 0.5 + cos(tick * 0.065) * window.innerWidth * 0.45;
  origin.y =
    window.innerHeight * 0.5 + sin(tick * 0.065) * window.innerHeight * 0.225;

  circles.push(getCricle(origin.x, origin.y, tick));
