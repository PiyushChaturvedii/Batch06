...
export const Header = () => {
 ...
 document.documentElement.classList.remove('dark')
  ...
  const activeClass =
    "text-base block py-2 px-3 text-blue-400 rounded hover:bg-neutral-tertiary md:hover:bg-transparent md:border-0 md:hover:text-fg-brand md:p-0 md:dark:hover:bg-transparent";
  const inActiveClass =
  ...
  return (
    <header>
      <nav className="bg-white border-gray-300 px-2 sm:px-4 py-2 rounded dark:bg-gray-900 dark:border-gray-900">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            ...
            <span className="self-center text-2xl text-heading font-semibold whitespace-nowrap dark:text-white">
              Cinemate
            </span>
          </Link>
          ...
          >
            ...
            <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-default rounded-base bg-neutral-secondary-soft md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-neutral-primary dark:text-white">
              <li>
                <NavLink
                  to="/"
                  className={({ isActive }) =>
